...
\makeatother
\subtitle{Capítulo 05 --- Gabarito e critérios}
...
\hypertarget{capuxedtulo-05-gabarito-e-crituxe9rios}{%
\section{Capítulo 05 --- Gabarito e
critérios}\label{capuxedtulo-05-gabarito-e-crituxe9rios}}
...
\hypertarget{exercuxedcios-9a-e-9b-a-declarauxe7uxe3o-dos-direitos-humanos-da-ia}{%
\subsection{Exercícios 9a e 9b --- A Declaração dos Direitos Humanos da
IA}\label{exercuxedcios-9a-e-9b-a-declarauxe7uxe3o-dos-direitos-humanos-da-ia}}

Oito artigos da DUDH, quatro em cada exercício. Para cada um, pede-se a
relação com a IA \textbf{e um exemplo}. O exemplo é obrigatório:
resposta sem exemplo é incompleta, por mais bem formulada que seja.

\textbf{Relações esperadas, artigo a artigo:}
...
\bottomrule\noalign{}
\endlastfoot
1 --- liberdade e igualdade em dignidade & sistemas que classificam
pessoas por características arbitrárias; a dignidade não pode ser objeto
de otimização \\
7 --- igualdade perante a lei & decisão automatizada em crédito,
seleção, policiamento preditivo; o caso Svea Ekonomi (cap. 6) serve de
exemplo \\
12 --- privacidade & vigilância, inferências de alto risco, dados
biométricos; RGPD \\
25 --- padrão de vida adequado & sistemas de triagem em saúde e
benefícios sociais; o caso de Helsinque \\
18 --- pensamento e consciência & sistemas de recomendação e bolhas
informacionais; manipulação de comportamento \\
21 --- participação no governo & desinformação algorítmica,
microssegmentação eleitoral \\
26 --- educação & notas atribuídas por algoritmo (o caso que abre o cap.
6); acesso desigual a tecnologia educacional \\
27 --- vida cultural e autoria & dados de treinamento e obras
protegidas; distribuição dos benefícios do avanço científico \\
\end{longtable}

\textbf{O 9b tem uma exigência a mais:} o material é dirigido a crianças
de 10 a 12 anos. A resposta precisa mostrar \textbf{adaptação de
linguagem e de exemplo}, não apenas simplificação. Um exemplo adequado
para essa faixa parte de algo que a criança vive --- o vídeo que aparece
recomendado, o jogo, o filtro de foto.
...
\bottomrule\noalign{}
\endlastfoot
Relaciona artigo e IA & genérico & relação clara & relação precisa e não
óbvia \\
Fornece exemplo & ausente & presente & concreto e verificável \\
9b: adequação à faixa etária & linguagem adulta & simplificada & parte
da experiência da criança \\
\end{longtable}

\textbf{Erro comum no 9b:} apenas encurtar as frases do 9a. Simplificar
vocabulário não é adaptar: o exemplo precisa mudar.

\begin{center}\rule{0.5\linewidth}{0.5pt}\end{center}

\hypertarget{exercuxedcio-10-limitar-o-truxe1fego-de-pedestres}{%
\subsection{Exercício 10 --- Limitar o tráfego de
pedestres}\label{exercuxedcio-10-limitar-o-truxe1fego-de-pedestres}}

\textbf{Sem resposta certa.} As duas posições --- liberdade de locomoção
ou segurança no trânsito --- podem render respostas excelentes.
...
\tightlist
\item
  tomar posição explícita, e não apenas expor os dois lados;
\item
  reconhecer que ambos são direitos, e não apenas preferências;
\item
  justificar a hierarquia adotada com um critério, e não por intuição.
\end{itemize}

Respostas excelentes fazem ao menos uma destas coisas:

\begin{itemize}
\tightlist
\item
  questionam a própria dicotomia, como o texto do capítulo sugere --- é
  uma falsa escolha, produzida por uma solução técnica que talvez nunca
  fosse viável;
\item
  notam a \textbf{redistribuição de responsabilidade}: a proposta
  transfere o ônus da segurança do fabricante do veículo para o
  pedestre;
\item
  usam o paralelo do \emph{jaywalking} --- a criminalização de
  atravessar fora da faixa não existia até que as vias fossem
  reconcebidas em torno do automóvel. Quem tem o ônus de se adaptar
  revela quem detém poder.
\end{itemize}
...
\bottomrule\noalign{}
\endlastfoot
Toma posição & expõe sem decidir & decide & decide e enfrenta a objeção
mais forte \\
Trata ambos como direitos & trata um como capricho & reconhece ambos &
discute a priorização entre direitos \\
Vai além da dicotomia & aceita os termos dados & questiona & usa o
paralelo histórico \\
\end{longtable}

\textbf{Erro comum:} responder como se fosse pergunta de opinião pessoal
(``acho que segurança é mais importante''), sem critério que sustente a
hierarquia.
