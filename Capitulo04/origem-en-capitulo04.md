...
::: {.nota data-titulo="What makes a system a “black box”?"}
...
![Distill example](img/distill-example.png)
...
::: {.tecnica data-titulo="How to make models more transparent?"}
...
O material original traz aqui um questionário interativo (id `f94f13d3`). As perguntas não constam do repositório — ficam no banco de dados da plataforma. Redija o exercício correspondente em `exercicios/`.
:::
...
![Techical reinforcement learning algorithm](img/rl1.svg)

<span style="font-size: 30px">2.</span>

![Robot reinforcement learning algorithm](img/rl2.svg)

  

<span style="font-size: 30px">3.</span>

![Cat reinforcement learning algorithm](img/rl3.svg)
...
::: {.reflexao data-titulo="Questionário do original"}
O material original traz aqui um questionário interativo (id `ed8ccfc3`). As perguntas não constam do repositório — ficam no banco de dados da plataforma. Redija o exercício correspondente em `exercicios/`.
:::
